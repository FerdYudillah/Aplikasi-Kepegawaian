                    ...
                    <form action="{{ route('simpan.berkala',[Request::segment(3)]) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="gaji_id" class="form-select select2 @error('gaji_id') is-invalid @enderror" id="gaji_id">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="file" class="form-control col-4 @error('sk_naik_pangkat_akhir') is-invalid @enderror" id="sk_naik_pangkat_akhir" name="sk_naik_pangkat_akhir" >
                                @error('sk_naik_pangkat_akhir')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                             @enderror
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="file" class="form-control col-4 @error('sk_mangku_jabat') is-invalid @enderror" id="sk_mangku_jabat" name="sk_mangku_jabat" >
                                @error('sk_mangku_jabat')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                             @enderror
