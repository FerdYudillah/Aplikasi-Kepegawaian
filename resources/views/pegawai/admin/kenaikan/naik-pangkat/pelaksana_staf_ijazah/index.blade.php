        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p>Merupakan Seluruh Data PNS yang Mengusulkan Kenaikan Pangkat Untuk Jabatan Pelaksana/Staf Penyesuaian Ijazah</p>
                    <a href="{{ route('cetak.rekap.psi',['3']) }}" class="btn  btn-success"><i class='bx bxs-printer' style='color:#f3eeee'  ></i> Cetak Laporan</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="{{ route('approval.psi',[$item->id]) }}" class="btn btn-warning btn-sm">  <i class="bx bx-edit"></i></a>
