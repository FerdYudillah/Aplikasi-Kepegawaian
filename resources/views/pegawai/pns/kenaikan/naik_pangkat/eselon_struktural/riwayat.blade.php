        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5>Riwayat Pangkat PNS Jabatan Reguler Eselon Struktural : {{ auth()->user()->name }} - {{ auth()->user()->nip }}</h5>
                    <a href="{{ route('tambah.pangkat.struktural',['new']) }}" class="btn btn-info">Tambah Data</a>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-sm datatables-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ isset($item->pangkat_pns->nama_pangkat) ? $item->pangkat_pns->nama_pangkat: ''}}/{{ $item->gol_baru }}</td>
                                ...
                                <td>
                                   ...
                                   <a href="{{ route('tambah.pangkat.struktural',[$item->id]) }}" class="btn btn-warning btn-sm">  <i class="bx bx-edit"></i></a>
