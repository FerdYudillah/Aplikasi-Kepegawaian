        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5>Riwayat Pangkat PNS Jabatan Fungsional Tertentu : {{ auth()->user()->name }} - {{ auth()->user()->nip }}</h5>
                    <a href="{{ route('tambah.pangkat.ft',['new']) }}" class="btn btn-danger">Tambah Data</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="{{ route('tambah.pangkat.ft',[$item->id]) }}" class="btn btn-warning btn-sm">  <i class="bx bx-edit"></i></a>
