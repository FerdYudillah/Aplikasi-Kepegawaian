        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('tambah.pangkat.psi',['new']) }}" class="btn btn-secondary">Tambah Data</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="{{ route('tambah.pangkat.psi',[$item->id]) }}" class="btn btn-warning btn-sm">  <i class="bx bx-edit"></i></a>
