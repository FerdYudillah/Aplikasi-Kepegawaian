...
<title>APK-KMK | Data Kenaikan Pangkat PNS Jabatan Reguler Eselon Struktural - Satpol PP & Damkar Tapin</title>@section('css')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('cetak.list.res',['1']) }}" class="btn  btn-primary"><i class='bx bxs-printer' style='color:#f3eeee'  ></i> Cetak Laporan</a>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-sm datatables-basic">
                        ...
                        <tbody>
                            @php
                                 $no = 1;
                            @endphp
                            @foreach ($naikPangkat as $key => $item)
                            <tr>
                                <td>{{ $no }}</td>
                                <td>{{ $no++ }}</td>
                                ...
                                <td>
                                   ...
                                   <a href="{{ route('approval.struktural',[$item->id]) }}" class="btn btn-warning btn-sm">  <i class="bx bx-edit"></i></a>
