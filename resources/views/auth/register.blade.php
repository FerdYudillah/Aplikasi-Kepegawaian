                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('create.register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" value="{{ old('nip') }}" required autocomplete="nip" autofocus>
                        ...
                        <div class="row mb-3">
                            <label for="nohp" class="col-md-4 col-form-label text-md-end">{{ __('No HP/WA') }}</label>
