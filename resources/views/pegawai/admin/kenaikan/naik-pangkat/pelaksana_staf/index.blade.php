        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('cetak.list.ps',['2']) }}" class="btn  btn-primary"><i class='bx bxs-printer' style='color:#f3eeee'  ></i> Cetak Laporan</a>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-sm datatables-basic">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><strong>{{ $item->naik_selanjutnya }}</strong></td>
                                <td>{{ $item->ket }}</td>
                                <td>
