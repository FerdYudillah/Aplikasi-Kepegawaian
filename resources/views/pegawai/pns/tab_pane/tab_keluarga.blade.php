<div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
    <form action="{{ route('update.sutri', $user->id) }}" method="POST">
    @method('put')
    @csrf
    <div class="row">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                       ...
                       <form onsubmit="return confirm('Yakin Mau Hapus Data??')" action="{{ route('anak.delete', $item->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
    ...
    <div>
        <a href="{{ route('anak.tambah') }}" class="btn btn-primary mt-3">Input Data Anak</a>
    </div>
</div>
