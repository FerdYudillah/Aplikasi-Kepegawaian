...
<title>SI-KMK | Usul kenaikan Pangkat PNS Jabatan Pelaksana/Staf Penyesuaian Ijazah - Satpol PP & Damkar Tapin</title>
@section('content')
<div class="container">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title"><strong>Usul Kenaikan Pangkat PNS Jabatan Pelaksana/Staf Penyesuaian Ijazah</strong></h3>
                    <p>Silahkan Isi Data yang diperlukan</p>
                </div>
                <div class="card-body">
                    <form action="{{ route('simpan.pangkat.psi',['kenaikan_id'=>Request::segment(3)]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="jenis_usulan" value="3">
                         <div class="row">
                        ...
                        <div class="row">
                         ...
                         <a href="{{ route('menu.pangkat.pestafijazah') }}" class="btn btn-danger">Kembali</a>
                    </form>
                </div>
            </div>
        </div>
